...
echo.
echo ===== CHAY TEST WINDOWS / LOGIC V3.6.0 =====
...
echo AUTO MODE: TU CHON CHE DO CO TY LE THANG TOT NHAT
echo DONG THUAN: KET HOP MODE TOT + CHUOI TANG/GIAM + DAO MODE YEU NEU DU DIEU KIEN
